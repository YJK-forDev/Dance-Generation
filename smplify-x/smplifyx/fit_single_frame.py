# 이 파일을 smplify-x/smplifyx/fit_single_frame.py로 대체해야 함
...
def fit_single_frame(img,
                     ...
                     output_folder='.',
                     result_fn='out.pkl',
                     result_fin='out_fin.pkl',
                     mesh_fn='out.obj',
                     smplx_fn = '',
                     camera_fn='camera.pkl',
